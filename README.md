...
| **3. Retrieval** | `ChromaDBRetriever` | ベクトル化された情報を保存・管理し、ユーザーの質問ベクトルと最も意味が近い文書を高速に検索します。 |
| **4. Query Expansion** | `HydeQueryEnhancer` | ユーザーの短い質問から、LLMが架空の理想的な回答（Hypothetical Document）を生成。この架空の回答で検索することで、検索キーワードを補い精度を向上させます。 |
